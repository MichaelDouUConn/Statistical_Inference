...
inference(y = weight, x = habit, data = nc, type = "ci", statistic = "mean", method = "theoretical")
```
...
inference(y = weeks, data = nc, type = "ci", statistic = "mean", conf_level = 0.90, method = "theoretical")
```
...
inference(y = weight, x = mature, data = nc, statistic = "mean", type = "ci", method = "theoretical")
```
...
ggplot(na.omit(nc), aes(x = mature, y = fage)) +
  geom_boxplot()
```
